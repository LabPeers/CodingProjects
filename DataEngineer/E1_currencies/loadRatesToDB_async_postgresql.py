...
class Downloader:
    ...
    async def write_to_database(self,data):
        mysql='''INSERT INTO HistoricExchangeRates (
            lookup_date,
            currency_rate_date,
            base_currency_code,
            ...
            BRL ,RUB ,HRK ,JPY ,THB ,
            CHF ,EUR ,MYR ,BGN ,TRY ,CNY ,
            NOK ,NZD ,ZAR ,USD ,MXN ,SGD ,
            AUD ,ILS ,KRW ,PLN ) VALUES 
            ...
            for l in range(0,len(lastday)):#Iterate through months
                ...
                for k in range(1,lastday[l]+1):#Iterate through days of each month
                    ...
                    async with client.get(myurl) as response:
                        ...
                        data_monthly.append((lookup_date,exchange_rates['date'],exchange_rates['base']) + tuple(myrates.values()))


                await self.write_to_database(data_monthly)
